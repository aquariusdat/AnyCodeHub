    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
            ...
            <div className="w-full max-w-5xl flex flex-col md:flex-row rounded-3xl overflow-hidden shadow-2xl bg-white dark:bg-gray-800 m-4">
                            ...
                            {authMode === "signup" && (
                                <form onSubmit={signUpForm.handleSubmit(onSignUp)} className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <input
                                                ...
                                                className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.firstName
                                                    ? "border-red-500"
                                                    : "border-transparent"
                                                    }`}
                                        ...
                                        <div>
                                            <input
                                                ...
                                                className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.lastName
                                                    ? "border-red-500"
                                                    : "border-transparent"
                                                    }`}
                                    ...
                                    <div>
                                        <input
                                            type="date"
                                            className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.birthOfDate
                                                ? "border-red-500"
                                                : "border-transparent"
                                                }`}
                                    ...
                                    <div>
                                        <input
                                            type="email"
                                            placeholder="Email"
                                            className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.email
                                                ? "border-red-500"
                                                : "border-transparent"
                                                }`}
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.phoneNumber
                                                ? "border-red-500"
                                                : "border-transparent"
                                                }`}
                                    ...
                                    <div>
                                        <input
                                            type="password"
                                            placeholder="Password"
                                            className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.password
                                                ? "border-red-500"
                                                : "border-transparent"
                                                }`}
                                    ...
                                    <div>
                                        <input
                                            ...
                                            className={`w-full px-4 py-3 bg-gray-100 dark:bg-gray-700 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent dark:text-white ${signUpForm.formState.errors.passwordConfirmed
                                                ? "border-red-500"
                                                : "border-transparent"
                                                }`}
                ...
                {/* Purple Section */}
                <div className="w-full md:w-1/2 bg-gradient-to-br from-purple-600 to-purple-800 p-8 md:p-12 flex flex-col justify-center items-center text-white overflow-hidden relative min-h-[400px]">
                    {/* Content with animation */}
                    <div
                        className={`relative z-10 text-center max-w-md flex flex-col items-center transition-all duration-500 ease-in-out transform ${isAnimating ? "opacity-0 translate-y-8" : "opacity-100 translate-y-0"
                            }`}
                    >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-60">
                        <svg
                            className="w-3/4 h-auto text-white"
                            viewBox="0 0 200 200"
                            xmlns="http://www.w3.org/2000/svg"
                        >
                            <path
                                fill="currentColor"
                                d="M37.5,-48.1C52.6,-38.9,71.2,-33.5,79.4,-21.3C87.6,-9.1,85.3,10,76.8,25.1C68.4,40.3,53.8,51.5,38.3,58.8C22.8,66.1,6.4,69.3,-9.7,68.3C-25.8,67.3,-41.6,62,-51.1,51.3C-60.6,40.6,-63.9,24.5,-65.7,8.8C-67.6,-6.9,-68,-22.3,-60.6,-33.6C-53.2,-45,-38,-52.3,-23.9,-61.8C-9.8,-71.3,3.2,-82.8,13.9,-78C24.5,-73.1,42.8,-52,37.5,-48.1Z"
